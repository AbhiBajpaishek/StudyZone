...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHMain" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSourceLogin" runat="server" ConnectionString="<%$ ConnectionStrings:StudyZoneConnectionString %>" SelectCommand="SELECT [User_id] FROM [Tbl_Login]"></asp:SqlDataSource>

    <asp:SqlDataSource ID="SqlDataSourceFeedback" runat="server" ConnectionString="<%$ ConnectionStrings:StudyZoneConnectionString %>" SelectCommand="SELECT * FROM [Tbl_Feedback]"></asp:SqlDataSource>

    <asp:SqlDataSource ID="SqlDataSourceEnquiry" runat="server" ConnectionString="<%$ ConnectionStrings:StudyZoneConnectionString %>" SelectCommand="SELECT * FROM [Tbl_Enquiry]"></asp:SqlDataSource>
        ...
        <div id="record">
            <div id="one">
                <div id="feedback">
                    ...
                    <br />
                    <br />
                    <asp:GridView ID="GridViewFeedback" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSourceFeedback" ForeColor="#333333" GridLines="None" Width="100%" HorizontalAlign="Center">
                ...
                <br />
                    <br />
                    <asp:GridView ID="GridViewEnquiry" runat="server" AllowPaging="True" PageSize="2" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Enquiry_id" DataSourceID="SqlDataSourceEnquiry" ForeColor="#333333" GridLines="None" HorizontalAlign="Center">
                        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                        <Columns>
            ...
            <div id="two">
                ...
                <br />
                <asp:GridView ID="GridViewLogin" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="User_id" DataSourceID="SqlDataSourceLogin" ForeColor="#333333" GridLines="None" Width="100%">
                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                    <Columns>
